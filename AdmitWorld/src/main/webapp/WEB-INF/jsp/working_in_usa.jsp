					    ...
					    <div class="container">
							...
							<div class="entry-content">
								<div id="et-boc" class="et-boc">
			                         ...
			                         <h2 style="color:#00A8E8">Working in USA during studies in USA | Part-time Work in USA as a student</h2>
									...
									<p>
										...
										you 2 more additional years of work. Many <a
											...
											target="_blank" rel="noopener noreferrer" style="color:#00A8E8">programs in the
											US</a>, especially tech programs, are STEM degrees. Learn more
										about <a
											href="stem_course_in_usa"
											target="_blank" rel="noopener noreferrer" style="color:#00A8E8">STEM courses in
											the US</a>.
									</p>
									<hr>
									<h2 id="study-ms-in-us">Study in the USA</h2>
									<p>As one of the leading US Education Counsellors in Mumbai, our US education experts will be happy to help you with your plans to study Masters in USA.</p>
									...
									<p>Much more...</p>
									<p><a href="contact_us" target="_blank" rel="noopener noreferrer" style="color:#00A8E8">Contact us</a> to book your consultation today to help you materialize your plans to study in the USA!</p>
                                     <hr>
                                     <p>You may also be interested in:</p>
                                     <h4 id="bachelors-in-usa" ><a href="bachelors_in_usa" target="_blank" rel="noopener noreferrer" style="color:#00A8E8">Bachelors in USA</a></h4>
                                     <h4 id="masters-in-usa"><a href="ms_in_usa" style="color:#00A8E8">Masters in USA</a></h4>
                                     <h4 id="mba-in-usa"><a href="mba_in_usa" target="_blank" rel="noopener noreferrer" style="color:#00A8E8">MBA in USA</a></h4>
								</div>
