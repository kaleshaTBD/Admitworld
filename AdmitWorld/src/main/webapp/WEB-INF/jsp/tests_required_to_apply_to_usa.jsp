					    ...
					    <div class="container">
							...
							<div class="entry-content">
								<div id="et-boc" class="et-boc">
									<h1 style="color:#00A8E8">Tests Required to Apply to USA</h1>
									<p>Understand Tests Required to Apply to USA for programs
										such as MBA, Masters, Bachelors.</p>
									<p>&nbsp;</p>
									<h2 style="color:#00A8E8">MBA in USA:</h2>
									<p>
									...
									<p>&nbsp;</p>
									<h2 style="color:#00A8E8">Masters in USA:</h2>
									<p>
									...
									<p>&nbsp;</p>
									<h2 style="color:#00A8E8" style="color:#00A8E8">Bachelors in USA:</h2>
									<p>
										You need to appear for two tests - <a
											href="sat1"
											target="_blank" style="color:#00A8E8">SAT</a> or <a
											href="act" target="_blank" style="color:#00A8E8">ACT</a> and
									...
									<p>
										...
										either <a href="toefl" target="_blank" style="color:#00A8E8">TOEFL</a>
										or <a href="ielts" target="_blank" style="color:#00A8E8">IELTS</a>.
										No <a href="gmat" target="_blank" style="color:#00A8E8">GMAT</a>
										or <a href="gre" target="_blank" style="color:#00A8E8">GRE</a>
										is required
									</p>
									<p>&nbsp;</p>
									...
									<p>
										<a href="toefl"
											target="_blank" rel="noopener noreferrer" style="color:#00A8E8">TOEFL</a> is
									...
									<p>
										...
										English. <a href="ielts"
											target="_blank" rel="noopener noreferrer" style="color:#00A8E8">IELTS</a> has the
									...
									<p>
										...
										that conducts the <a href="toefl"
											target="_blank" style="color:#00A8E8">TOEFL</a>. It tests your verbal reasoning,
										...
										more about <a href="gre"
											target="_blank" style="color:#00A8E8">GRE</a>, <a href="gre"
											target="_blank" rel="noopener noreferrer" style="color:#00A8E8">click here.</a>
									</p>
									<p>&nbsp;</p>
									<h3>
									...
									<p>
										...
										about <a href="gmat" target="_blank" style="color:#00A8E8">GMAT</a>,
									...
									<h3>
										<a href="sat1"
											target="_blank" style="color:#00A8E8">SAT</a> &#8211;
									</h3>
									<p>
										...
										all about <a href="sat1"
											...
											rel="noopener noreferrer" style="color:#00A8E8">click here.</a>
									</p>
									<p>&nbsp;</p>
									<h3 style="color:#00A8E8">MCAT &#8211;</h3>
