			      ...
			      <div id="hero-wrapper">
					    ...
					    <div class="container">
							...
							<div class="entry-content">
								<h1 style="color: #00A8E8" >Common Questions – FAQs &#8211; USA</h1>
								<h2></h2>
								<h2 style="color: #00A8E8">5 Common Questions – FAQs &#8211; USA</h2>
								<h3></h3>
								<h3 style="color: #00A8E8">Where can I stay off campus?</h3>
								...
								<p>&nbsp;</p>
								<h3 style="color: #00A8E8">What&#8217;s an Ivy League Institute?</h3>
								<p>
								...
								<p>&nbsp;</p>
								<h3 style="color: #00A8E8">What&#8217;s the difference between assistantships and
									fellowships?</h3>
								<h4 style="color: #00A8E8">Assistantships &#8211;</h4>
								<p>Students provide services to the university e.g.
									...
									resume!</p>
								<h4 style="color: #00A8E8">Fellowships &#8211;</h4>
								<p>Students receive funds from the university without having
									to give anything back.</p>
								<p>&nbsp;</p>
								<h3 style="color: #00A8E8">I want a scholarship to study in USA. What can I do?</h3>
								<p>
								...
								<p>&nbsp;</p>
								<h3 style="color: #00A8E8">What is MA USA?</h3>
								...
								<p>
									Please <a href="contact_us" target="_blank"
										rel="noopener noreferrer" style="color: #00A8E8">contact us</a> in case you are
